...
public class JingqDetailWithUnhandleActivityWithSearch extends BaseActivity implements IJingqDetailWithUnhandleView {
    ...
    public static Intent createIntent(Context context) {
        Intent intent = new Intent(context, JingqDetailWithUnhandleActivityWithSearch.class);
        return intent;
    }
...
//    }
    ...
    public void onClick(View view) {
        if(view.getId() == R.id.btn_search_by_jingqid){
